...
public class Config {
    ...
    public static final String GUI_CHOOSE 	 = "Escoger nombre:";
    public static final String GUI_WELCOME 	 = "Bienvenido al grupo " + GROUP_IP + ":" + CHAT_PORT;
    public static final String GUI_TITLE 	 = "Chat Multicast";
    public static final String GUI_ERROR 	 = "Error";
    public static final String GUI_ERROR_MESSAGE = "Nombre no puede ser vacío";
    ...
    public static final String GUI_CLOSE 	 = "Salir";
    public static final String GUI_CLOSE_MESSAGE = "¿Seguro que desea salri?";
    public static final String GUI_CHOOSE_NICK 	 = "Escoger nombre:";
    public static final int GUI_WIDTH 		 = 640;
    public static final int GUI_HEIGHT 		 = 480;
    public static final String GUI_BUTTON_FIRE 	 = "Enviar";
    public static final String GUI_BUTTON_OK 	 = "OK";
    public static final String GUI_NEW_LINE 	 = "\n";
    public static final String GUI_QUIT 	 = "Salir";
}
