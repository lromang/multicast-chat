...
public class ChatGUI implements ActionListener, KeyListener, WindowListener {
	...
	private static SimpleDateFormat dateFormat = new SimpleDateFormat(Config.GUI_DATE_FORMAT);
	private String name;
	...
	public ChatGUI() {
		...
		chat.setFont(new Font(Config.GUI_CHAT_FONT, Font.PLAIN, Config.GUI_CHAT_FONT_SIZE));
